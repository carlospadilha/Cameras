...
function MessageBox() {
wrap="<div id='versionB' style='position:absolute;font-family: ����, Arial, Helvetica, sans-serif;color: #000000;width:215px;height:220px;margin:200px 0 0 50%;z-index:1000;background-color: RGB(255,255,255)'>"
        +"<div style='background-color: RGB(242,242,242);width:215px;height:30px;'>"
            +"</div>"
            +"<div style='width:215px;height:160px;'>"
